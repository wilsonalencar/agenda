...
<div class="row">
    ...
    <div class="col-md-1">
        ...
        <?php echo Form::hidden('switch_val', $switch, ['class' => 'form-control']); ?>

        <?php echo Form::button('<i class="fa fa-refresh"></i> Atualizar', array('id' => 'atualiza_btn', 'class'=>'btn btn-default', 'type'=>'submit')); ?>
    ...
    <div class="col-md-1">
        ...
        <?php echo Form::button('<i class="fa fa-repeat"></i> Reset', array('id' => 'reset_btn', 'class'=>'btn btn-default', 'type'=>'submit')); ?>
...
$(function() {
    ...
    $('#estabelecimentos-table').DataTable({
        ...
        stateSave: true,
        ajax: {
                url: "<?php echo route('cargas.data'); ?>",
                data: function (d) {
        ...
        columns: [
            ...
            {data: 'id', name:'carga_entrada', searchable: false, orderable: false, render: function (data, type, row) {
                                                                  ...
                                                                  var url = '';
                                                                  <?php if( Auth::user()->hasRole('msaf') || Auth::user()->hasRole('admin') || Auth::user()->hasRole('owner')): ?>
                                                                  if(row['carga_msaf_entrada']==1) {
                                                                      url += '<a href="<?php echo e(route('cargas.changeStateEntrada', array('0', ':id_estab'))); ?>"><img src="<?php echo e(URL::to('/')); ?>/assets/img/Green-icon.png" title="carga entrada efetuada" /></a>';
                                                                  } else {
                                                                      url += '<a href="<?php echo e(route('cargas.changeStateEntrada', array('1', ':id_estab'))); ?>"><img src="<?php echo e(URL::to('/')); ?>/assets/img/Red-icon.png" title="carga entrada não efetuada" /></a>';
                                                                  }
                                                                  url = url.replace(':id_estab', data);
                                                                  <?php else: ?>
                                                                  if(row['carga_msaf_entrada']==1) {
                                                                        url += '<img src="<?php echo e(URL::to('/')); ?>/assets/img/Green-icon.png" title="carga entrada efetuada" />';
                                                                    } else {
                                                                        url += '<img src="<?php echo e(URL::to('/')); ?>/assets/img/Red-icon.png" title="carga entrada não efetuada" />';
                                                                    }
                                                                  <?php endif; ?>
                                                                  return url;
            }},
            {data: 'id', name:'carga_saida', searchable: false, orderable: false, render: function (data, type, row) {
                                                                  ...
                                                                  if(row['carga_msaf_saida']==1) {
                                                                        url += '<a href="<?php echo e(route('cargas.changeStateSaida', array('0', ':id_estab'))); ?>"><img src="<?php echo e(URL::to('/')); ?>/assets/img/Green-icon.png" title="carga saída efetuada" /></a>';
                                                                  } else {
                                                                        url += '<a href="<?php echo e(route('cargas.changeStateSaida', array('1', ':id_estab'))); ?>"><img src="<?php echo e(URL::to('/')); ?>/assets/img/Red-icon.png" title="carga saída não efetuada" /></a>';
                                                                  }
                                                                  url = url.replace(':id_estab', data);
                                                                  <?php else: ?>
                                                                    if(row['carga_msaf_saida']==1) {
                                                                          url += '<img src="<?php echo e(URL::to('/')); ?>/assets/img/Green-icon.png" title="carga saida efetuada" />';
                                                                      } else {
                                                                          url += '<img src="<?php echo e(URL::to('/')); ?>/assets/img/Red-icon.png" title="carga saida não efetuada" />';
                                                                      }
                                                                    <?php endif; ?>
                                                                  return url;
            }}
