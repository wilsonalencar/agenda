...
<div class="row">
    <div class="col-md-1 col-md-offset-1">
        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-default"><i class="fa fa-backward"></i> Voltar</a>
    </div>
    <div class="col-md-2">
    ...
    <div class="col-md-2 col-md-offset-4">
        <?php echo Form::select('tributo', $tributos, $tributo, ['style'=>'width:160px','class' => 'form-control']); ?>
...
?>
    ...
    var graph_data = [[<?php echo e(implode(',',$array_nentregue)); ?>],[<?php echo e(implode(',',$array_nentregue_vencidas)); ?>],[<?php echo e(implode(',',$array_aprovacao)); ?>],[<?php echo e(implode(',',$array_aprovacao_vencidas)); ?>],[<?php echo e(implode(',',$array_entregue)); ?>],[<?php echo e(implode(',',$array_entregue_vencidas)); ?>],[<?php echo e(implode(',',$sum)); ?>]];
    var graph_data_pie = [<?php echo e(array_sum($array_nentregue)); ?>,<?php echo e(array_sum($array_nentregue_vencidas)); ?>,<?php echo e(array_sum($array_aprovacao)); ?>,<?php echo e(array_sum($array_aprovacao_vencidas)); ?>,<?php echo e(array_sum($array_entregue)); ?>,<?php echo e(array_sum($array_entregue_vencidas)); ?>];
                ...
                point: {
                    events: {
                        click: function () {
                            ...
                            $.get("<?php echo e(url('/find-activities-detail')); ?>",
...
$( "#sendmail_btn" ).click(function() {
    ...
    $.ajax({
      url: 'sendEmailExport',
      type: "post",
      data: {'html_head': $(".modal-title").html(),'html_body': $(".modal-body").html(),'user_id': <?php echo e(Auth::user()->id); ?> },
