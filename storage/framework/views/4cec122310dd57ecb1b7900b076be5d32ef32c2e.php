...
<!-- CUSTOM CSS -->
<link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/assets/css/custom.css">
<!-- Smart Menus CSS -->
<link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/assets/css/sm-core-css.css" />
<link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/assets/css/sm-clean/sm-clean.css" />
...
<!-- Custom JS -->
<script src="<?php echo e(URL::to('/')); ?>/assets/js/custom.js"></script>
<!-- Smart Menus JS -->
<script src="<?php echo e(URL::to('/')); ?>/assets/js/jquery.smartmenus.min.js"></script>

<!--- format moeda -->
<script src="<?php echo e(URL::to('/')); ?>/assets/js/jquery.maskMoney.js"></script>
