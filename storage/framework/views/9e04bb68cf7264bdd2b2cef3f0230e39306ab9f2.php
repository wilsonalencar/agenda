...
<hr>
<?php echo Form::open([
    'route' => 'movtocontacorrentes.action_import',
    'files'=>true,
    'id'=>'form_import', 
    'name' => 'form_import'
]); ?>
...
<a href="<?php echo e(route('movtocontacorrente')); ?>" class="btn btn-default">Voltar</a>
...
<script>
    function submit_form()
    {
        ...
        $.ajax({
            ...
            url: '/movtocontacorrentes/action_valid_import',
            data: formData,
            processData: false,
            contentType: false,
            dataType: "json",
