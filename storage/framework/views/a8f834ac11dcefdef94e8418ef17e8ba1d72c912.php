<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <div style="display:inline; position:relative; top:5px; font-family:'Arial', 'Helvetica', sans-serif; font-size:21px;"><span><font color="red"><b>B</b></font>ravo - Tax Calendar</span> <!--- <img style="height:20px; margin-bottom: 5px" src="<?php echo e(URL::to('/')); ?>/assets/img/v_logo_small.png" /><span>agenda</span>--></div>
    </div>
        ...
        <li><a href="#">|</a></li>
            ...
            <?php if( Auth::user()->hasRole('msaf') || Auth::user()->hasRole('analyst') || Auth::user()->hasRole('supervisor') || Auth::user()->hasRole('admin')): ?>
                 <li><a href="#"><i class="fa fa-btn fa-table"></i>Tax Calendar</a>
                        <ul>
                            <li></li>
                            <li><a href="<?php echo e(route('movtocontacorrente')); ?>"><i class="fa fa-btn fa-file-text-o"></i>Conta Corrente</a></li>
                            <li><a href="<?php echo e(route('processosadms.index')); ?>"><i class="fa fa-btn fa-file-text-o"></i>Processos Administrativos</a></li>
                        </ul>
                 </li>
                 <li><a href="#">|</a></li>
            <?php endif; ?>
            ...
            <?php if( Auth::user()->hasRole('admin') || Auth::user()->hasRole('owner') || Auth::user()->hasRole('supervisor')): ?>
                <li><a href="#"><i class="fa fa-btn fa-table"></i> Configurações</a>
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('mensageriaprocadms.create')); ?>">Mensageria</a></li>
                        <?php endif; ?>
