...
<p class="lead">Segue a lista de todos os estabelecimentos cadastrados. <a href="<?php echo e(route('estabelecimentos.create')); ?>">Adicionar outro?</a></p>
<hr>
...
$(function() {
    ...
    $('#estabelecimentos-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo route('estabelecimentos.data'); ?>",
        columns: [
            ...
            {data: 'id', name:'edit', searchable: false, orderable: false, render: function (data) {
                                                    ...
                                                    var url = '<a href="<?php echo e(route('estabelecimentos.edit', ':id_edit')); ?>" class="btn btn-default btn-sm">Alterar</a>';
                                                    url += '<a href="<?php echo e(route('estabelecimentos.show', ':id_show')); ?>" style="margin-left:10px" class="btn btn-default btn-sm">Mostrar</a>';
