...
<div style="float:left; width:60%">
    <h2>ENTREGA</h2><small>(REF. #<?php echo e($atividade->id); ?>)</small>
    ...
    <div class="panel panel-default">
            ...
            <div style="padding:20px" class="panel-body">
                <div class="row">
                    <?php if( Auth::user()->hasRole('admin') || Auth::user()->hasRole('owner') || Auth::user()->hasRole('supervisor')): ?>
                        ...
                        <?php endif; ?>
                        <?php if($atividade->status == 3 && false): ?>
                        <div class="col-md-3">
            ...
            <div class="panel-footer clearfix">
                <div class="pull-right">
                    <a href="<?php echo e(route('entregas.index')); ?>" class="btn btn-default">Voltar</a>
                </div>
            </div>
    </div>
