...
<h1>Empresas</h1>
<p class="lead">Segue a lista de todas as empresas cadastradas. <a href="<?php echo e(route('empresas.create')); ?>">Adicionar outra?</a></p>
<hr>
...
$(function() {
    ...
    $('#empresas-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo route('empresas.data'); ?>",
        columns: [
            /*{data: 'id', name: 'id'},*/
            ...
            {data: 'id', name:'edit', searchable: false, orderable: false, render: function (data) {
                                                    ...
                                                    var url = '<a href="<?php echo e(route('empresas.edit', ':id_edit')); ?>" class="btn btn-default btn-sm">Alterar</a>';
                                                    url += '<a href="<?php echo e(route('empresas.show', ':id_show')); ?>" style="margin-left:10px" class="btn btn-default btn-sm">Mostrar</a>';
