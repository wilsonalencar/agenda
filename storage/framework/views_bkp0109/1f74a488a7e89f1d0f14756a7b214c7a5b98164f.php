...
$(function() {
    ...
    $('#atividades-table').DataTable({
        ...
        stateSave: true,
        ajax: {
                url: "<?php echo route('atividades.data'); ?>",
                data: function (d) {
        ...
        columns: [
            ...
            {data: 'id', name:'edit', searchable: false, orderable: false, render: function (data) {
                        ...
                        //var url = '<a href="<?php echo e(route('atividades.edit', ':id_edit')); ?>" class="btn btn-default btn-sm">Alterar</a>';
                        var url = '<a href="<?php echo e(route('atividades.show', ':id_show')); ?>" style="margin-left:10px" class="btn btn-default btn-sm">Mostrar</a>';
    ...
    $('#adv_search').on('click', function(e) {
                    ...
                    if (val_cnpj || val_codigo) {
                        var url = "<?php echo e(route('atividades.index')); ?>?vcn="+val_cnpj.replace(/[^0-9]/g,'')+"&vco="+val_codigo.replace(/[^0-9]/g,'');
                    } else {
                        var url = "<?php echo e(route('atividades.index')); ?>";
                    }
